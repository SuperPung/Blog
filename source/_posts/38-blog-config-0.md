...
>
> [这个博客网站](/)最初建成于 2020 年 1 月 14 日左右，陆续由于换了四次电脑，博客也迁移了三次。从建成至今，不知不觉已经过了一年多。一年多来，随着各种软件的升级迭代，每次迁移都意味着需要重新配置新的功能，同时也见证了 Git、Hexo 和 NexT 的发展。
>
...
如果你不满足于此，想要添加更多的功能，可以看 [下一篇文章](/blog-config-1) 。
